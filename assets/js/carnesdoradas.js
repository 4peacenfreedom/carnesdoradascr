(function ($) {
  ...
  // jarallax
  $(".carnesdoradas-jarallax").jarallax({});
  ...
  // Date Picker
  if ($(".carnesdoradas-datepicker").length) {
    $(".carnesdoradas-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  //accordion
  if ($(".carnesdoradas-accordion").length) {
    var accordionGrp = $(".carnesdoradas-accordion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".carnesdoradas-accordion." + accordionName)
                .find(".accordion")
                .removeClass("active");
              $(".carnesdoradas-accordion." + accordionName)
                .find(".accordion")
  ...
  function thmOwlInit() {
    // owl slider
    let carnesdoradasowlCarousel = $(".carnesdoradas-owl__carousel");
    if (carnesdoradasowlCarousel.length) {
      carnesdoradasowlCarousel.each(function () {
        let elm = $(this);
    ...
    let carnesdoradasowlCarouselNav = $(".carnesdoradas-owl__carousel--custom-nav");
    if (carnesdoradasowlCarouselNav.length) {
      carnesdoradasowlCarouselNav.each(function () {
        let elm = $(this);
    ...
    let carnesdoradasowlCarouselWithCounter = $(
      ".carnesdoradas-owl__carousel--with-counter"
    );
    if (carnesdoradasowlCarouselWithCounter.length) {
      carnesdoradasowlCarouselWithCounter.each(function () {
        let elm = $(this);
        let options = elm.data("owl-options");
        ...
        elm
          .on("initialized.owl.carousel", function (event) {
            ...
            elm.append(
              '<div class="carnesdoradas-owl__carousel__counter"><span class="carnesdoradas-owl__carousel__counter__current"></span> / <span class="carnesdoradas-owl__carousel__counter__total"></span></div>'
            );
            elm
              .find(".carnesdoradas-owl__carousel__counter__current")
              .text(
                addLeadingZero(carousel.relative(carousel.current()) + 1, 2)
              );
            elm
              .find(".carnesdoradas-owl__carousel__counter__total")
  ...
  //Strech Column
  function carnesdoradas_stretch() {
    var i = $(window).width();
    $(".row .carnesdoradas-stretch-element-inside-column").each(function () {
      var $this = $(this),
  ...
  carnesdoradas_stretch();

  function carnesdoradas_cuved_circle() {
